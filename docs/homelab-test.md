...
A real-world end-to-end smoke test of purple-wolf v0.4.4 (WAF + relay)
...
│   pulls ghcr.io/guaracloud/purple-wolf-wasm:0.4.4, copies the   │
...
- The two GHCR images, public-accessible from the cluster's nodes:
  - `ghcr.io/guaracloud/purple-wolf-relay:0.4.4`
  - `ghcr.io/guaracloud/purple-wolf-wasm:0.4.4`
